...
export type StorySlideInput = Pick<
  StoryDocument,
  'workItemId' | 'title' | 'narrative' | 'pmComments' | 'area' | 'cycle'
>;

export async function generatePpt(stories: StorySlideInput[]): Promise<Buffer> {
